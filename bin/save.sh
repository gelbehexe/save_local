...
# full save
REMOVE_OLD_AFTER_DAYS=30
REMOVE_OLD_EXCLUDE_ERROR=0
REMOVE_OLD_KEEP_FULL=1
_CMD_REMOVE_OLD_AFTER_DAYS=
_CMD_REMOVE_OLD_EXCLUDE_ERROR=
_CMD_REMOVE_OLD_KEEP_FULL=
...
OVERRIDE_EXISTING_BACKUPS=0
#SPLITSIZE=150
MAX_JOBS=3
MAX_MAIL_LOG_LEN=50
_DRY_RUN=0
_NO_FULL_TIMESTAMP=0
_NO_FULL_TIMESTAMP_REASONS=()
...
_CMD_SPLIT=
_CMD_MAX_JOBS=
_CMD_FORCE_FULL_TIMESTAMP=0
_CMD_OVERRIDE_EXISTING_BACKUPS=0
